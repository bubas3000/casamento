  ...
  <!-- 
	...
	<body>
		...
		<script>
			...
			var countDownDate = new Date("September 21, 2024 17:00:00").getTime();
				...
				<div class="row row-bottom-padded-md">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<div class="wedding-events">
							<div class="ceremony-bg " style="background-image: url(images/igreja_comp.jpg);"></div>
							<div class="desc">
								<h3>Igreja e Jantar</h3>
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
							...
							<p>Querida Família e queridos Amigos, a vossa presença será o nosso melhor presente. No entanto, se desejarem colaborar para a nova fase da nossa vida deixamos NIB, pedindo que indiquem o nome na transferência para que possamos agradecer individualmente.</p>
								<p><strong>IBAN: PT50 0035 0001 0004 4887 6309 0</strong>
								<br><strong><strong>MBWAY: 910 142 726 | 915 988 611</strong></strong></p></div>
					...
					<div class="row animate-box">
						<div class="col-md-8 col-md-offset-2 text-center heading-section">
							<h2 style="color: #92c0cd;">Música que não pode faltar?</h2>
						</div>
					</div>
					<div class="row animate-box">
						<div class="col-md-10 col-md-offset-1">
							<form action="https://script.google.com/macros/s/AKfycbyAeAU_HsW3iqK6QcvlqpZHas_jdrb11o8HoNTiz3uV_tjWtXUKWQFApWjotkgRBusyYQ/exec" method="POST" id="Musica" class="form-inline">
			...
			<style>
				...
				* {box-sizing: border-box;}
				...
				.form-popup {
				  ...
				  top: 0;
  				  left: 0;
				  background-image: url(images/igreja_form3.jpg);
				  background-position: center;
				...
				function closeForm1() {
				  document.getElementById("myForm1").style.display = "none";
								...
								<div class="w3-content w3-display-container">
									<img class="mySlides" src="images/Utrecht.jpg" style="width:100%">
				...
				<div class="container">
					<div class="row">
						...
						<div class="form-popup" id="myForm1">
							<form method="POST" action="https://script.google.com/macros/s/AKfycbxeyswBizHIOnxNTZ9aEmcl1gDk2M9hl9-l1fcJ-0xENGJmqSBc6NZzS64d5ZTX7UBQ-A/exec"  class="form-container" id = "rsvp">
							  <h1 style="color: white;">Confirme a sua presença</h1>
